...
function sA:ShowExportFrame(exportString)
    ...
    if not frame then
        ...
        local closeBtn = CreateFrame("Button", "sAExportCloseButton", frame, "UIPanelButtonTemplate")
...
function sA:ShowImportFrame()
    ...
    if not frame then
        ...
        local importBtn = CreateFrame("Button", "sAImportImportButton", frame, "UIPanelButtonTemplate")
        ...
        local cancelBtn = CreateFrame("Button", "sAImportCancelButton", frame, "UIPanelButtonTemplate")
