...
SlashCmdList["sA"] = function(msg)
	...
	if cmd == "showlearning" then
		if sA.SuperWoW then
			...
			if num and num >= 0 and num <= 1 then
				...
				sA:Msg("Usage: /sa showlearning X - shows new AuraDurations learned in chat (1 = show. Default: 0)")
	...
	sA:Msg("/sa showlearning X - shows new AuraDurations learned in chat (1 = show. Default: 0)")
